...
export const AboutView = () => {
    ...
    return (<>
        ...
        <Text fontSize={'l'}>Skończyłem liceum o profilu zarządzania informacją, podczas nauki nauczyłem się
            ...
            pracowałem w zespole, nabyłem <strong>umiejętności komunikatywności i rozwiązywania problemów</strong>.
            ...
            interesować się językiem <strong>Python oraz JS</strong>. Programowaniem hobbystycznie zajmowałem się od
            2019 roku. Od
            początku
        ...
        <UnorderedList>
            ...
            <ListItem><strong>MegaK</strong> - JavaScript, podstawy JS, NodeJs, Express, TS, React, SQL,
                NestJS</ListItem>
